...
import dtri.com.tw.service.ScheduleProductionNotesServiceAc;
import dtri.com.tw.shared.CloudExceptionService;
import dtri.com.tw.shared.PackageBean;
import dtri.com.tw.shared.PackageService;

@RestController
public class ScheduleProductionNotesControllerAc extends AbstractControllerAc {

	@Autowired
	private PackageService packageService;
	@Autowired
	private ScheduleProductionNotesServiceAc serviceAc;

	@RequestMapping(value = { "/scheduleProductionNotes/getSearch" }, method = {
	...
	@RequestMapping(value = { "/scheduleProductionNotes/setModify" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/scheduleProductionNotes/setAdd" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/scheduleProductionNotes/setInvalid" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/scheduleProductionNotes/setDetele" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
