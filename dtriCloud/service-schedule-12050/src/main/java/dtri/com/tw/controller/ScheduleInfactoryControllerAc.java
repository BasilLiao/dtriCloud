...
import dtri.com.tw.service.ScheduleInfactoryServiceAc;
import dtri.com.tw.shared.CloudExceptionService;
import dtri.com.tw.shared.PackageBean;
import dtri.com.tw.shared.PackageService;

@RestController
public class ScheduleInfactoryControllerAc extends AbstractControllerAc {

	@Autowired
	private PackageService packageService;
	@Autowired
	private ScheduleInfactoryServiceAc serviceAc;

	@RequestMapping(value = { "/scheduleInfactory/getSearch" }, method = {
	...
	@ResponseBody
	@RequestMapping(value = { "/scheduleInfactory/setModifySc" }, method = {
	...
	@ResponseBody
	@RequestMapping(value = { "/scheduleInfactory/setModifyMc" }, method = {
			RequestMethod.PUT }, produces = "application/json;charset=UTF-8")
	...
	@ResponseBody
	@RequestMapping(value = { "/scheduleInfactory/setModifyWm" }, method = {
			RequestMethod.PUT }, produces = "application/json;charset=UTF-8")
	...
	@ResponseBody
	@RequestMapping(value = { "/scheduleInfactory/setModifyMp" }, method = {
			RequestMethod.PUT }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/scheduleInfactory/getReport" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/scheduleInfactory/setInvalid" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@ResponseBody
	@RequestMapping(value = { "/scheduleInfactory/setDelete" }, method = {
