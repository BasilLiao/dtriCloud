...
import dtri.com.tw.service.ScheduleProductionHistoryServiceAc;
import dtri.com.tw.shared.CloudExceptionService;
import dtri.com.tw.shared.PackageBean;
import dtri.com.tw.shared.PackageService;

@RestController
public class ScheduleProductionHistoryControllerAc extends AbstractControllerAc {

	@Autowired
	private PackageService packageService;
	@Autowired
	private ScheduleProductionHistoryServiceAc serviceAc;

	@RequestMapping(value = { "/scheduleProductionHistory/getSearch" }, method = {
	...
	@RequestMapping(value = { "/scheduleProductionHistory/getReport" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/scheduleProductionHistory/setModify" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/scheduleProductionHistory/setAdd" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/scheduleProductionHistory/setInvalid" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/scheduleProductionHistory/setDetele" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
