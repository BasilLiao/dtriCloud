...
public interface ScheduleProductionHistoryDao extends JpaRepository<ScheduleProductionHistory, Long> {
	...
	ArrayList<ScheduleProductionHistory> findAllBySearch(String sphbpmnb, String sphbpmmodel, String sphonb,
	...
	ArrayList<ScheduleProductionHistory> findAllByCheck(String sphbpmnb, String sphbpmmodel, Pageable pageable);
