...
public class BomItemSpecifications {
	...
	private Long bisgid;
	@Column(name = "bis_nb", nullable = false, columnDefinition = "varchar(50) default ''")
	...
	@Column(name = "bis_f_name", nullable = false, columnDefinition = "varchar(150) default ''")
	...
	@Column(name = "bis_g_condition", nullable = false, columnDefinition = "varchar(50) default ''")
