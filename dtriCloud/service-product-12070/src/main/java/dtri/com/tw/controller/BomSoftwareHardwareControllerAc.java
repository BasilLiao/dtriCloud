...
import dtri.com.tw.service.BomKeeperServiceAc;
import dtri.com.tw.service.BomSoftwareHardwareServiceAc;
import dtri.com.tw.shared.CloudExceptionService;
import dtri.com.tw.shared.PackageBean;
import dtri.com.tw.shared.PackageService;

@RestController
public class BomSoftwareHardwareControllerAc extends AbstractControllerAc {

	@Autowired
	private PackageService packageService;
	@Autowired
	private BomSoftwareHardwareServiceAc serviceAc;

	@RequestMapping(value = { "/bomSoftwareHardware/getSearch" }, method = {
	...
	@RequestMapping(value = { "/bomSoftwareHardware/getReport" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/bomSoftwareHardware/setModify" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/bomSoftwareHardware/setAdd" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/bomSoftwareHardware/setInvalid" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/bomSoftwareHardware/setDetele" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
