...
import dtri.com.tw.service.BiosLifeCycleServiceAc;
import dtri.com.tw.shared.CloudExceptionService;
import dtri.com.tw.shared.PackageBean;
import dtri.com.tw.shared.PackageService;

@RestController
public class BiosLifeCycleControllerAc extends AbstractControllerAc {

	@Autowired
	private PackageService packageService;
	@Autowired
	private BiosLifeCycleServiceAc serviceAc;

	@RequestMapping(value = { "/biosLifeCycle/getSearch" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	PackageBean getBiosLifeCycleSearch(@RequestBody String jsonObject) {
		// 顯示方法
