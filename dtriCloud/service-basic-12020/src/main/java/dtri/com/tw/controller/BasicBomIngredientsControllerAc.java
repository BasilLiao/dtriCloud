...
import dtri.com.tw.service.BasicBomIngredientsServiceAc;
import dtri.com.tw.shared.CloudExceptionService;
import dtri.com.tw.shared.PackageBean;
import dtri.com.tw.shared.PackageService;

@RestController
public class BasicBomIngredientsControllerAc extends AbstractControllerAc {

	@Autowired
	private PackageService packageService;
	@Autowired
	private BasicBomIngredientsServiceAc serviceAc;

	@RequestMapping(value = { "/basicBomIngredients/getSearch" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/basicBomIngredients/getReport" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/basicBomIngredients/setModify" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/basicBomIngredients/setAdd" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/basicBomIngredients/setInvalid" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/basicBomIngredients/setDetele" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
