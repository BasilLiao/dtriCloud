...
import dtri.com.tw.service.BasicProductModelServiceAc;
import dtri.com.tw.shared.CloudExceptionService;
import dtri.com.tw.shared.PackageBean;
import dtri.com.tw.shared.PackageService;

@RestController
public class BasicProductModelControllerAc extends AbstractControllerAc {

	@Autowired
	private PackageService packageService;
	@Autowired
	private BasicProductModelServiceAc serviceAc;

	@RequestMapping(value = { "/basicProductModel/getSearch" }, method = {
	...
	@RequestMapping(value = { "/basicProductModel/getReport" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/basicProductModel/setModify" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/basicProductModel/setAdd" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/basicProductModel/setInvalid" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/basicProductModel/setDetele" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
