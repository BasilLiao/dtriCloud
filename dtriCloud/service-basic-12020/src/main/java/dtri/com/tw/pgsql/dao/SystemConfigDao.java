...
public interface SystemConfigDao extends JpaRepository<SystemConfig, Long> {
	...
	ArrayList<SystemConfig> findAllByConfig(String scname, String scgname, //
			Date sysmdatestart, Date sysmdateend, Integer sysstatus, Boolean sysheader, Pageable pageable);
