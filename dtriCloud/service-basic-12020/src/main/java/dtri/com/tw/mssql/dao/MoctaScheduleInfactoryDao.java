...
public interface MoctaScheduleInfactoryDao extends JpaRepository<MoctaScheduleInfactory, Long> {
	...
	ArrayList<MoctaScheduleInfactory> findAllByMocta(String ta001ta002, String ta013);
