...
import dtri.com.tw.service.SystemPermissionServiceAc;
import dtri.com.tw.shared.CloudExceptionService;
import dtri.com.tw.shared.PackageBean;
import dtri.com.tw.shared.PackageService;

@RestController
public class SystemPermissionControllerAc extends AbstractControllerAc {

	@Autowired
	private PackageService packageService;
	@Autowired
	private SystemPermissionServiceAc serviceAc;

	@RequestMapping(value = { "/systemPermission/getSearch" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/systemPermission/getReport" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/systemPermission/setModify" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/systemPermission/setAdd" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/systemPermission/setInvalid" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/systemPermission/setDetele" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
