...
import dtri.com.tw.service.SystemUserServiceAc;
import dtri.com.tw.shared.CloudExceptionService;
import dtri.com.tw.shared.PackageBean;
import dtri.com.tw.shared.PackageService;

@RestController
public class SystemUserControllerAc extends AbstractControllerAc {

	@Autowired
	private PackageService packageService;
	@Autowired
	private SystemUserServiceAc serviceAc;

	@RequestMapping(value = { "/systemUser/getSearch" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/systemUser/getReport" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/systemUser/setModify" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/systemUser/setAdd" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/systemUser/setInvalid" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/systemUser/setDetele" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
