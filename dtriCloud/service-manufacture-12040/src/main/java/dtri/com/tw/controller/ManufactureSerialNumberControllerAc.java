...
import dtri.com.tw.service.ManufactureSerialNumberServiceAc;
import dtri.com.tw.shared.CloudExceptionService;
import dtri.com.tw.shared.PackageBean;
import dtri.com.tw.shared.PackageService;

@RestController
public class ManufactureSerialNumberControllerAc extends AbstractControllerAc {

	@Autowired
	private PackageService packageService;
	@Autowired
	private ManufactureSerialNumberServiceAc serviceAc;

	@RequestMapping(value = { "/manufactureSerialNumber/getSearch" }, method = {
	...
	@RequestMapping(value = { "/manufactureSerialNumber/getReport" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/manufactureSerialNumber/setModify" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/manufactureSerialNumber/setAdd" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/manufactureSerialNumber/setInvalid" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/manufactureSerialNumber/setDetele" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
