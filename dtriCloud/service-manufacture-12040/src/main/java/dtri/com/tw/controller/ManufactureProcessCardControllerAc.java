...
import dtri.com.tw.service.ManufactureProcessCardServiceAc;
import dtri.com.tw.shared.CloudExceptionService;
import dtri.com.tw.shared.PackageBean;
import dtri.com.tw.shared.PackageService;

@RestController
public class ManufactureProcessCardControllerAc extends AbstractControllerAc {

	@Autowired
	private PackageService packageService;
	@Autowired
	private ManufactureProcessCardServiceAc serviceAc;

	@RequestMapping(value = { "/manufactureProcessCard/getSearch" }, method = {
	...
	@RequestMapping(value = { "/manufactureProcessCard/getReport" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/manufactureProcessCard/setModify" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/manufactureProcessCard/setAdd" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/manufactureProcessCard/setInvalid" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/manufactureProcessCard/setDetele" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
