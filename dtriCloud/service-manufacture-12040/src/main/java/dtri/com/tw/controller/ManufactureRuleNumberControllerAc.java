...
import dtri.com.tw.service.ManufactureRuleNumberServiceAc;
import dtri.com.tw.shared.CloudExceptionService;
import dtri.com.tw.shared.PackageBean;
import dtri.com.tw.shared.PackageService;

@RestController
public class ManufactureRuleNumberControllerAc extends AbstractControllerAc {

	@Autowired
	private PackageService packageService;
	@Autowired
	private ManufactureRuleNumberServiceAc serviceAc;

	@RequestMapping(value = { "/manufactureRuleNumber/getSearch" }, method = {
	...
	@RequestMapping(value = { "/manufactureRuleNumber/getReport" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/manufactureRuleNumber/setModify" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/manufactureRuleNumber/setAdd" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/manufactureRuleNumber/setInvalid" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/manufactureRuleNumber/setDetele" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
