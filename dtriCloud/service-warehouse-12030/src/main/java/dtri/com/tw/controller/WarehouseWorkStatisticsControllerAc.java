...
import dtri.com.tw.service.WarehouseWorkStatisticsServiceAc;
import dtri.com.tw.shared.CloudExceptionService;
import dtri.com.tw.shared.PackageBean;
import dtri.com.tw.shared.PackageService;

@RestController
public class WarehouseWorkStatisticsControllerAc extends AbstractControllerAc {

	@Autowired
	private PackageService packageService;
	@Autowired
	private WarehouseWorkStatisticsServiceAc serviceAc;

	@RequestMapping(value = { "/warehouseWorkStatistics/getSearch" }, method = {
	...
	@RequestMapping(value = { "/warehouseWorkStatistics/getReport" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/warehouseWorkStatistics/setModify" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/warehouseWorkStatistics/setAdd" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/warehouseWorkStatistics/setInvalid" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/warehouseWorkStatistics/setDetele" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
