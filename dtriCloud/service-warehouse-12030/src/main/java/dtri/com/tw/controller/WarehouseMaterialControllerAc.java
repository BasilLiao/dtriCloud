...
import dtri.com.tw.service.WarehouseMaterialServiceAc;
import dtri.com.tw.shared.CloudExceptionService;
import dtri.com.tw.shared.PackageBean;
import dtri.com.tw.shared.PackageService;

@RestController
public class WarehouseMaterialControllerAc extends AbstractControllerAc {

	@Autowired
	private PackageService packageService;
	@Autowired
	private WarehouseMaterialServiceAc serviceAc;

	@RequestMapping(value = { "/warehouseMaterial/getSearch" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/warehouseMaterial/getReport" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/warehouseMaterial/setModify" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/warehouseMaterial/setAdd" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/warehouseMaterial/setInvalid" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = { "/warehouseMaterial/setDetele" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
