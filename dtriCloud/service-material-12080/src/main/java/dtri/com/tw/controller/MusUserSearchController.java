...
import dtri.com.tw.service.MusUserSearchService;
import dtri.com.tw.shared.CloudExceptionService;
import dtri.com.tw.shared.PackageBean;
import dtri.com.tw.shared.PackageService;

@RestController
public class MusUserSearchController extends AbstractControllerAc {

    @Autowired
    private MusUserSearchService musUserSearchService;

    @Autowired
    private PackageService packageService;

    @RequestMapping(value = { "/musUserSearch/setMusUserSearch" }, method = {
    ...
    PackageBean getSearch(@RequestBody String jsonObject) {
        ...
        try {
            ...
            musUserSearchService.setMussearch(packageBean);
