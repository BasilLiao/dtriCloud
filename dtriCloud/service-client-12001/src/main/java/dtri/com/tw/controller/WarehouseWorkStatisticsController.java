...
@Controller
public class WarehouseWorkStatisticsController extends AbstractController {
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/warehouse_work_statistics.basil" }, method = {
	...
	String access(@RequestBody String jsonObject) {
		...
		try {
			...
			// Step3.執行=>跨服->務執行
			packageBean = serviceFeign.getWorkStatisticsSearch(packageService.beanToJson(packageBean));
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/warehouse_work_statistics.basil.AR" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/warehouse_work_statistics.basil.ARR" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/warehouse_work_statistics.basil.AC" }, method = { RequestMethod.POST })
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/warehouse_work_statistics.basil.AU" }, method = { RequestMethod.PUT })
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/warehouse_work_statistics.basil.AD" }, method = { RequestMethod.DELETE })
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/warehouse_work_statistics.basil.DD" }, method = { RequestMethod.DELETE })
