...
@Controller
public class ManufactureActionController extends AbstractController {
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/manufacture_action.basil.AC" }, method = { RequestMethod.POST })
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/manufacture_action.basil.AU" }, method = { RequestMethod.PUT })
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/manufacture_action.basil.S1" }, method = { RequestMethod.PUT })
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/manufacture_action.basil.AD" }, method = { RequestMethod.DELETE })
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/manufacture_action.basil.DD" }, method = { RequestMethod.DELETE })
