...
@Controller
public class BomItemSpecificationsController extends AbstractController {
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/bom_item_specifications.basil" }, method = {
	...
	String access(@RequestBody String jsonObject) {
		...
		try {
			...
			// Step3.執行=>跨服->務執行
			packageBean = serviceFeign.getItemSpecificationsSearch(packageService.beanToJson(packageBean));
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/bom_item_specifications.basil.AR" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	String searchTest(@RequestBody String jsonObject) {
		...
		try {
			...
			// Step3.執行=>跨服->務執行
			packageBean = serviceFeign.getItemSpecificationsSearchTest(packageService.beanToJson(packageBean));
			loggerInf(funName + "[End]", loginUser().getUsername());
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/bom_item_specifications.basil.ARR" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	String report(@RequestBody String jsonObject) {
		...
		try {
			...
			// Step3.執行=>跨服->務執行
			packageBean = serviceFeign.getItemSpecificationsReport(packageService.beanToJson(packageBean));
			loggerInf(funName + "[End]", loginUser().getUsername());
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/bom_item_specifications.basil.AC" }, method = { RequestMethod.POST })
	String add(@RequestBody String jsonObject) {
		...
		try {
			...
			// Step3.執行=>跨服->務執行
			packageBean = serviceFeign.setItemSpecificationsAdd(packageService.beanToJson(packageBean));
			loggerInf(funName + "[End]", loginUser().getUsername());
	...
	String modify(@RequestBody String jsonObject) {
		...
		try {
			...
			// Step3.執行=>跨服->務執行
			packageBean = serviceFeign.setItemSpecificationsModify(packageService.beanToJson(packageBean));
			loggerInf(funName + "[End]", loginUser().getUsername());
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/bom_item_specifications.basil.AD" }, method = { RequestMethod.DELETE })
	String invalid(@RequestBody String jsonObject) {
		...
		try {
			...
			// Step3.執行=>跨服->務執行
			packageBean = serviceFeign.setItemSpecificationsInvalid(packageService.beanToJson(packageBean));
			loggerInf(funName + "[End]", loginUser().getUsername());
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/bom_item_specifications.basil.DD" }, method = { RequestMethod.DELETE })
	String delete(@RequestBody String jsonObject) {
		...
		try {
			...
			// Step3.執行=>跨服->務執行
			packageBean = serviceFeign.setItemSpecificationsDetele(packageService.beanToJson(packageBean));
			loggerInf(funName + "[End]", loginUser().getUsername());
