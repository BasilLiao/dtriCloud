...
public class BasicCommandListController extends AbstractController {
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/basic_command_list.basil" }, method = {
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/basic_command_list.basil.AR" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/basic_command_list.basil.ARR" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
