...
@Controller
public class BasicCommandListController extends AbstractController {
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/basic_command_list.basil" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/basic_command_list.basil.AR" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/basic_command_list.basil.ARR" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/basic_command_list.basil.AC" }, method = { RequestMethod.POST })
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/basic_command_list.basil.AU" }, method = { RequestMethod.PUT })
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/basic_command_list.basil.AD" }, method = { RequestMethod.DELETE })
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/basic_command_list.basil.DD" }, method = { RequestMethod.DELETE })
