...
@Controller
public class ScheduleOutsourcerController extends AbstractController {
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/schedule_outsourcer.basil" }, method = {
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/schedule_outsourcer.basil.AR" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/schedule_outsourcer.basil.ARR" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
