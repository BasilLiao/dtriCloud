...
@Controller
public class BasicShippingListController extends AbstractController {
	...
	String access(@RequestBody String jsonObject) {
		...
		try {
			...
			// Step3.執行=>跨服->務執行
			packageBean = serviceFeign.getShippingListSearch(packageService.beanToJson(packageBean));
	...
	String report(@RequestBody String jsonObject) {
		...
		try {
			...
			// Step3.執行=>跨服->務執行
			packageBean = serviceFeign.getShippingListReport(packageService.beanToJson(packageBean));
			loggerInf(funName + "[End]", loginUser().getUsername());
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/basic_shipping_list.basil.AC" }, method = { RequestMethod.POST })
	String add(@RequestBody String jsonObject) {
		...
		try {
			...
			// Step3.執行=>跨服->務執行
			packageBean = serviceFeign.setShippingListAdd(packageService.beanToJson(packageBean));
			loggerInf(funName + "[End]", loginUser().getUsername());
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/basic_shipping_list.basil.AU" }, method = { RequestMethod.PUT })
	String modify(@RequestBody String jsonObject) {
		...
		try {
			...
			// Step3.執行=>跨服->務執行
			packageBean = serviceFeign.setShippingListModify(packageService.beanToJson(packageBean));
			loggerInf(funName + "[End]", loginUser().getUsername());
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/basic_shipping_list.basil.AD" }, method = { RequestMethod.DELETE })
	String invalid(@RequestBody String jsonObject) {
		...
		try {
			...
			// Step3.執行=>跨服->務執行
			packageBean = serviceFeign.setShippingListInvalid(packageService.beanToJson(packageBean));
			loggerInf(funName + "[End]", loginUser().getUsername());
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/basic_shipping_list.basil.DD" }, method = { RequestMethod.DELETE })
	String delete(@RequestBody String jsonObject) {
		...
		try {
			...
			// Step3.執行=>跨服->務執行
			packageBean = serviceFeign.setShippingListDetele(packageService.beanToJson(packageBean));
			loggerInf(funName + "[End]", loginUser().getUsername());
