...
public class AiChatController extends AbstractController {
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/ai_chat.basil.AR" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/ai_chat.basil.ARR" }, method = {
			RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/ai_chat.basil.AC" }, method = { RequestMethod.POST })
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/ai_chat.basil.AU" }, method = { RequestMethod.PUT })
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/ai_chat.basil.AD" }, method = { RequestMethod.DELETE })
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/ai_chat.basil.DD" }, method = { RequestMethod.DELETE })
