...
public class BiosVersionController extends AbstractController {
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/bios_version.basil" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/bios_version.basil.AR" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	...
	@ResponseBody
	@RequestMapping(value = { "/ajax/bios_version.basil.ARR" }, method = { RequestMethod.POST }, produces = "application/json;charset=UTF-8")
